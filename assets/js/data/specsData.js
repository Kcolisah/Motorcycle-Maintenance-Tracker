(() => {
  ...
  window.MT_BRAND_ACCENT_MAP = window.MT_BRAND_ACCENT_MAP || brandAccentMap;
  window.MT_BIKE_SPECS_MAP = window.MT_BIKE_SPECS_MAP || bikeSpecsMap;

  window.getMotorcycleSpecFallback = window.getMotorcycleSpecFallback || function getMotorcycleSpecFallback(model) {
    return window.MT_BIKE_SPECS_MAP?.[model] || {};
  };

  window.getMotorcycleBrandAccent = window.getMotorcycleBrandAccent || function getMotorcycleBrandAccent(brand) {
    return window.MT_BRAND_ACCENT_MAP?.[brand] || "#ff2b2b";
  };
})();
